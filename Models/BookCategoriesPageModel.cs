...
namespace Gramada_Cosmin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Gramada_Cosmin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Gramada_Cosmin_Lab8Context context,
